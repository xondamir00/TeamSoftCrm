...
export default function CreatePaymentForm({
  ...
  // UseForm options - type mismatch fix
  const formOptions = {
  ...
  const {
    ...
    reset,
    formState: { errors },
  } = useForm<PaymentFormData>(formOptions as any); // Type assertion
  ...
  const onSubmit = async (data: PaymentFormData) => {
    try {
      // Payment store'dagi submitPayment signature'siga mos keladigan object
      const paymentData = {
        studentId: data.studentId,
        studentName: selectedStudent?.fullName || "", // Store'dan olingan talaba nomi
        amount: data.amount,
        method: data.method,
