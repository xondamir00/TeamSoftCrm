...
export const StudentTable = ({
  ...
  return (
    <div className="bg-white mt-5 dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden transition-colors duration-300">
