            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 rounded-xl p-4 sm:p-5 border border-blue-200 dark:border-blue-800 transition-colors duration-300">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-blue-700 dark:text-blue-300 text-xs sm:text-sm font-medium mb-1">Total Students</p>
                    <p className="text-2xl sm:text-3xl font-bold text-blue-900 dark:text-blue-100">{totalStudents}</p>
                  </div>
              ...
              <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900 rounded-xl p-4 sm:p-5 border border-emerald-200 dark:border-emerald-800 transition-colors duration-300">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-emerald-700 dark:text-emerald-300 text-xs sm:text-sm font-medium mb-1">Active Students</p>
              ...
              <Table>
                <TableHeader className="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-700">
                  <TableRow className="border-b-2 border-slate-200 dark:border-slate-600">
                    ...
                    <TableHead className="font-bold text-slate-700 dark:text-slate-300 text-xs sm:text-sm hidden md:table-cell">Birth Date</TableHead>
                    <TableHead className="font-bold text-slate-700 dark:text-slate-300 text-xs sm:text-sm hidden lg:table-cell">Start Date</TableHead>
                ...
                <TableBody>
                  {students.length === 0 ? (
                    ...
                    students.map((student, index) => (
                      <TableRow key={student.id} className="hover:bg-blue-50/50 dark:hover:bg-blue-900/30 transition-colors border-b border-slate-100 dark:border-slate-700">
                        <TableCell className="font-medium text-slate-600 dark:text-slate-400 text-xs sm:text-sm">
                          {(page - 1) * limit + index + 1}
                        </TableCell>
                        <TableCell className="font-semibold text-slate-900 dark:text-white text-xs sm:text-sm">{student.fullName}</TableCell>
                        ...
                        <TableCell className="text-slate-600 dark:text-slate-400 text-xs sm:text-sm hidden lg:table-cell">{formatDate(student.startDate)}</TableCell>
