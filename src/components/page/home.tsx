...
export default function FinanceDashboard() {
  ...
  const getLineChartData = () => {
    ...
    if (range === "yearly") {
      ...
      labels = weeks;
      data = Array.from({ length: 4 }, () => Math.floor(Math.random() * 20) + 5);
    } else {
      labels = weekdays;
      data = Array.from({ length: 7 }, () => Math.floor(Math.random() * 15) + 3);
    }
  ...
  const lineChartData = {
    ...
    datasets: [
      {
        label: category === "income" ? "Tushumlar" : 
               category === "expense" ? "Chiqimlar" : "Foyda",
        data: lineData,
        borderColor: darkMode ? 
          (category === "income" ? "#059669" : 
           category === "expense" ? "#d97706" : "#2563eb") :
          (category === "income" ? "#10b981" : 
           category === "expense" ? "#f59e0b" : "#3b82f6"),
        backgroundColor: darkMode ? 
          (category === "income" ? "#05966920" : 
           category === "expense" ? "#d9770620" : "#2563eb20") :
          (category === "income" ? "#10b98120" : 
           category === "expense" ? "#f59e0b20" : "#3b82f620"),
        tension: 0.4,
        fill: true,
      ...
      tooltip: {
        ...
        callbacks: {
          label: (context: any) => {
            ...
            return `${category === "income" ? "Tushum" : 
                    category === "expense" ? "Chiqim" : "Foyda"}: ${value.toLocaleString('uz-UZ')} so'm`;
          },
        },
      },
    },
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {range === "yearly" ? "Yillik" : range === "monthly" ? "Oylik" : "Haftalik"} ko'rsatkichlar
                </p>
              </div>
              
              <div className="flex flex-wrap gap-3">
                <div className="flex bg-gray-100 dark:bg-gray-700 rounded-xl p-1">
                  {(["income", "expense", "profit"] as Category[]).map((cat) => (
                    <button
                      key={cat}
                      ...
                      className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${
                        category === cat 
                          ? `bg-gradient-to-r ${
                              cat === "income" ? "from-emerald-500 to-teal-600" :
                              cat === "expense" ? "from-amber-500 to-orange-600" :
                ...
                <div className="flex bg-gray-100 dark:bg-gray-700 rounded-xl p-1">
                  {(["yearly", "monthly", "weekly"] as Range[]).map((r) => (
                    ...
                    >
                      {r === "yearly" ? "Yil" : r === "monthly" ? "Oy" : "Hafta"}
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-100">
                      {format(new Date(financeOverview.from), 'dd.MM.yyyy')} - {format(new Date(financeOverview.to), 'dd.MM.yyyy')}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 rounded-xl bg-white/10 backdrop-blur-sm">
                    <span className="text-sm font-medium text-white">Tushumlar</span>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-xl bg-white/10 backdrop-blur-sm">
                    <span className="text-sm font-medium text-white">Chiqimlar</span>
                    <span className="text-lg font-bold text-white">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-xl bg-white/20 backdrop-blur-sm border border-white/30">
                    <span className="text-sm font-medium text-white">Sof foyda</span>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      {debtors.length} ta o'quvchi, jami {formatCurrency(globalBalance?.totalDebt)} qarz
                    </p>
                  </div>
                </div>
