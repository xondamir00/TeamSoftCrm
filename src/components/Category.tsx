...
export default function CategoryNav() {
  ...
  return (
    <header className="w-full">
      <div className="hidden md:flex justify-center py-3 bg-white my-4 w-[98%] mx-auto rounded-2xl dark:bg-black">
        <NavigationMenu>
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="right" className="p-0 bg-[#3F8CFF] dark:bg-black">
            <SheetHeader className="p-4 border-b border-white/30 dark:border-white/50">
              <SheetTitle className="text-white dark:text-white">Kategoriyalar</SheetTitle>
            </SheetHeader>
            <AnimatePresence>
              {open && (
                <motion.div
